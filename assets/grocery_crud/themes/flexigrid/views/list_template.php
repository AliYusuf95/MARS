...
<div class="row">
	...
	<div id='list-report-success' class='report-div alert alert-success col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3' <?php if($success_message !== null){?>style="display:block"<?php }?>>
		<?php
		if($success_message !== null){
			$title = substr($success_message,0,strpos($success_message,'<'));
			$message = substr($success_message,strpos($success_message,'<'));
			?>
			<h4><i class="icon fa fa-check"></i> <?php echo $title; ?></h4>
