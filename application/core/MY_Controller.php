...
class MY_Controller extends MX_Controller {
	...
	protected $mPageTitleSmall = '';
	protected $mBodyClass = '';
	protected $mMenu = array();
	protected $mMemberMenu = array();
	...
	private function _setup()
	{
		...
		$this->mMemberMenu = empty($config['member_menu']) ? array() : $config['member_menu'];
	...
	protected function render($view_file, $layout = 'default')
	{
		...
		$this->mViewData['page_title_small'] = $this->mPageTitleSmall;
		$this->mViewData['current_uri'] = empty($this->mModule) ? uri_string(): preg_replace('/'.preg_quote($this->mModule.'/', '/').'/', '', uri_string(), 1);
		...
		$this->mViewData['member_menu'] = $this->mMemberMenu;
